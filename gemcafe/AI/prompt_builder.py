...
SIMULATIONS = {
    ...
    "lift_slice": {
        ...
        "instruction_template": (
            ...
            "cut faces of the slice, with sponge layers, cream filling, "
            "and internal structure fully visible in cross-section\n"
            "- The slice's internal structure (sponge, cream, filling, "
            "toppings) is IDENTICAL to the design shown in the input image\n\n"
            ...
            "and angle exactly\n"
            "- The inner walls of the gap show clean cross-sections of the "
            "sponge and cream layers, identical in structure to the lifted "
            "slice's cut faces\n"
