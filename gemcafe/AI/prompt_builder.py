...
SIMULATIONS = {
    ...
    "fork_bite": {
        ...
        "video_template": (
            ...
            "undisturbed. The camera holds a steady slight high angle and the framing "
            "widens gently to keep both the cake and the lifted fork comfortably in view. "
            "Shallow depth of field, clean photorealistic dessert advertising aesthetic, "
            "smooth and graceful motion, no abrupt cuts."
        ),
    },
    # ─────────────────────────────────────────────────────────────────
    "cut_in_half": {
        ...
        "video_template": (
            ...
            "exposed with vivid color and natural texture.\n\n"
            "At the same time, the camera slowly pushes in toward the cake, starting from a "
            "wider view of the whole cake slice and ending as an extreme macro close-up of "
            "the split area where the fork meets the cake. The motion is smooth and "
            "continuous, gradually filling the frame with the texture of the sponge and "
            "cream around the fork, with the {focus} clearly emphasized as the dominant "
            "texture in the macro close-up.\n\n"
